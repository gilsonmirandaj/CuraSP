...
# Refatoração: agora busca eventos direto das páginas de eventos do Shotgun (Picles)
# e corrige links da Casa de Francisca.
SHOTGUN_EVENTS_URL = 'https://shotgun.live/venues/picles/events'
CASA_FRANCISCA_URL = 'https://acasadefrancisca.art.br/programacao'

print('Atualizado para usar páginas de eventos diretamente.')
